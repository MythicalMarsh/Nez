...
{
	public class SpriteRendererNotify : RenderableComponent
	{
		/// <summary>
		/// Whenever the sprite enters the camera view and unculls this sprite it will fire off this event.
		/// </summary>
		public event Action OnSpriteVisible;
		/// <summary>
		/// Whenever the sprite gets culled outside of the camera view it will fire off this event.
		/// </summary>
		public event Action OnSpriteInvisible;
		...
		public SpriteRendererNotify()
		{ }

		public SpriteRendererNotify(Texture2D texture) : this(new Sprite(texture))
		{ }

		public SpriteRendererNotify(Sprite sprite) => SetSprite(sprite);
		...
		/// </summary>
		public SpriteRendererNotify SetSprite(Sprite sprite)
		{
			_sprite = sprite;
			if (_sprite != null)
		...
		/// </summary>
		public SpriteRendererNotify SetOrigin(Vector2 origin)
		{
			if (_origin != origin)
			{
				_origin = origin;
		...
		/// </summary>
		public SpriteRendererNotify SetOriginNormalized(Vector2 value)
		{
		...
		{
			OnSpriteVisible?.Invoke();
		}

		protected override void OnBecameInvisible()
		{
			OnSpriteInvisible?.Invoke();
		}
